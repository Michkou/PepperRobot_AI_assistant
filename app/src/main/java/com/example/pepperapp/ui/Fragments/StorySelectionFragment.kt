...
class StorySelectionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.buttonStory1).setOnClickListener {
            ...
            findNavController().navigate(R.id.action_storySelectionFragment_to_listenStoryFragment, bundle)
        }
        ...
        view.findViewById<Button>(R.id.buttonStory3).setOnClickListener {
            val bundle = androidx.core.os.bundleOf("storyId" to 3)
            findNavController().navigate(R.id.action_storySelectionFragment_to_listenStoryFragment, bundle)
        }

        view.findViewById<Button>(R.id.buttonStory4).setOnClickListener {
            val bundle = androidx.core.os.bundleOf("storyId" to 4)
            findNavController().navigate(R.id.action_storySelectionFragment_to_listenStoryFragment, bundle)
        }
